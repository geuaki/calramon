...
router.post('/add', joiSchemaValidation.validate(productSchemas.createProductSchema, `body`), async (req, res) => {
...
router.post('/edit/:id', joiSchemaValidation.validate(productSchemas.editProductSchema, `body`), async (req, res) => {
    const { id } = req.params;
